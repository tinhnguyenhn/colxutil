...
func NewCoin(index int64, value colxutil.Amount, numConfs int64) coinset.Coin {
	h := fastsha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = colxutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = colxutil.NewTxFromBytes(testSimpleCoinTxBytes)
